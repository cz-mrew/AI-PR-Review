...
def test_get_builds_github_api_path(monkeypatch):
    ...
    assert FakeHttpxClient.calls[0]["method"] == "GET"
...
def test_create_issue_comment_posts_to_issue_comments_api(monkeypatch):
    FakeHttpxClient.calls = []
    FakeHttpxClient.payload = {
        "id": 456,
        "body": "This review was generated by AI PR Review Assistant.",
    ...
    assert FakeHttpxClient.calls == [
        {
            "method": "POST",
            "url": f"{GITHUB_API_BASE}/repos/owner/repo/issues/123/comments",
            "headers": {
                "Accept": "application/vnd.github+json",
                "User-Agent": "ai-pr-review",
                "Authorization": "Bearer test-token",
            },
            "json": {"body": "This review was generated by AI PR Review Assistant."},
            "timeout": 30,
        }
    ]
